...
const stats = [
  { value: "160+", label: "Credit Cards", icon: CreditCard },
  { value: "24", label: "Banks Covered", icon: Shield },
  { value: "50+", label: "Voucher Brands", icon: Star },
          ...
          <ScrollReveal>
            <div className="text-center max-w-3xl mx-auto">
              ...
              <div className="flex flex-wrap gap-3 justify-center">
                ...
                <Link to="/perk-ai" className="px-7 py-3 rounded-xl text-sm font-semibold glass-card border border-border/40 hover:border-gold/30 transition-colors inline-flex items-center gap-2">
